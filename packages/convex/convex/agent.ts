...
/**
 * Agent calls this after creating a file to register it for the web UI.
 */
export const registerWorkspaceFile = mutation({
    args: {
...
/**
 * Web UI calls this to list files published for a specific job.
 */
